...
- Product Showcase with Images: Each product/service card now includes two images tied directly to its description, giving visitors a clear visual of what’s offered.
- Hover Zoom Effect: Product images zoom slightly on hover, adding interactivity and polish.
...
- CSS3: For all styling, layout (Flexbox/Grid), animations, responsive design (using @media queries), and hover zoom effects.
